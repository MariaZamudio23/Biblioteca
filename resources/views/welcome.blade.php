...
<div class="flex pt-20">
    ...
    <main class="flex-1 p-6 md:ml-64">
        ...
        <!-- HERO -->
        <section class="relative rounded-lg overflow-hidden mb-10">
            <img
                src="https://images.unsplash.com/photo-1521587765099-efb68d6481bb"
                class="absolute inset-0 w-full h-full object-cover"
                alt="Biblioteca">

            <div class="relative bg-black/60 text-white p-12 text-center">
                ...
                <a href="#"
                   class="inline-block bg-blue-600 hover:bg-blue-700 px-8 py-3 rounded-full font-semibold">
                    Explorar
                </a>
            </div>
        </section>
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <article class="bg-white p-6 rounded-lg shadow text-center">
                <i class="fas fa-book-reader text-3xl text-blue-600 mb-4"></i>
